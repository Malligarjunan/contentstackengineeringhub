          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            ...
            {homepageContent.main_architecture_image_url && (
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-slate-200 hover:shadow-2xl transition-shadow">
                ...
                <div className="relative rounded-2xl overflow-hidden bg-slate-50 border border-slate-200 h-[500px] flex items-center justify-center group">
                  <img
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-3xl p-8 shadow-xl border border-indigo-200">
                ...
                <div className="space-y-4 overflow-auto h-[500px] pr-2">
                  {homepageContent.architecture_principles.map((item: any, i: number) => (
                    <div key={i} className="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-indigo-100 hover:shadow-md transition-shadow">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {homepageContent.architecture_diagrams.slice(0, 4).map((diagram: ArchitectureDiagram, i: number) => (
                <a
                  ...
                  className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-2 border-slate-100 hover:border-indigo-200 group cursor-pointer block"
                >
                  ...
                  {diagram.imageUrl ? (
                    ...
                    <div className="aspect-video bg-gradient-to-br from-indigo-50 to-blue-50 flex items-center justify-center">
                  ...
                  <div className="p-6">
                    <h4 className="font-bold text-slate-900 mb-2 text-sm group-hover:text-indigo-600 transition-colors flex items-center justify-between">
                    ...
                    <p className="text-slate-600 text-xs line-clamp-2 mb-2">{diagram.description}</p>
                    <div className="flex items-center gap-1 text-xs text-indigo-600 opacity-0 group-hover:opacity-100 transition-opacity font-semibold">
