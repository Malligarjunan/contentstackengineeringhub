          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-4 py-2 mb-6">
                <span className="text-white/90 text-sm font-medium">{product.category}</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                {product.repositoryUrl && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-white text-slate-900 rounded-xl font-bold hover:scale-105 transition-all"
                  >
                ...
                <Link
                  href="/products"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-md border-2 border-white/20 text-white rounded-xl font-bold hover:bg-white/20 transition-all"
                >
            ...
            <div className="flex items-center justify-center">
              <div 
                className="w-64 h-64 rounded-[4rem] flex items-center justify-center relative"
                style={{ backgroundColor: `${product.color}15` }}
              >
                <div 
                  className="w-32 h-32 rounded-[2rem] animate-pulse-slow"
                  style={{ backgroundColor: product.color }}
                />
                <div className="absolute inset-0 rounded-[4rem] bg-gradient-to-br from-white/10 to-transparent"></div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg border border-slate-100">
              ...
              {product.cicdDiagramImage && (
                <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-slate-50 to-blue-50 border-2 border-slate-200 mb-4">
                  <div className="aspect-video flex items-center justify-center p-8">
                    <div className="text-center">
                      <div className="w-20 h-20 mx-auto bg-gradient-to-br from-green-500 to-blue-500 rounded-2xl flex items-center justify-center mb-4">
                        <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" />
                        </svg>
                      </div>
                      <p className="text-slate-600 font-semibold mb-2">CI/CD Pipeline Diagram</p>
                      <p className="text-sm text-slate-500">{product.cicdDiagramImage}</p>
                    </div>
                  </div>
                </div>
              )}
