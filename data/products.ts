...
export const products: Product[] = [
  {
    ...
    intro: `<h3>Welcome to Content Management API</h3><p>The <strong>Content Management API (CMA)</strong> is your gateway to programmatic content operations in Contentstack. Whether you're building automation workflows, migrating content, or creating custom content management tools, CMA provides the robust foundation you need.</p><h3>Key Capabilities</h3><ul><li><strong>Full CRUD Operations:</strong> Create, read, update, and delete content entries, assets, and content types</li><li><strong>Bulk Operations:</strong> Process multiple content items efficiently with batch endpoints</li><li><strong>Workflow Management:</strong> Integrate with content workflows and publishing mechanisms</li><li><strong>Asset Management:</strong> Upload, organize, and manage digital assets programmatically</li></ul><p>This API is designed for developers who need powerful, flexible control over their content infrastructure.</p>`,
    category: "CMS",
    color: "#6C5CE7",
...
5. python manage.py runserver
  ...
  },
  {
    ...
    intro: `<h3>Welcome to Agent OS</h3><p><strong>Agent OS</strong> is Contentstack's revolutionary intelligent agent framework that brings AI-powered automation to your content operations. Built on cutting-edge AI/ML technologies, Agent OS enables you to create sophisticated agents that can understand context, make intelligent decisions, and execute complex workflows autonomously.</p><h3>Core Capabilities</h3><ul><li><strong>Intelligent Reasoning:</strong> AI agents that understand context and make informed decisions using LangChain and advanced LLMs</li><li><strong>Workflow Automation:</strong> Automate complex content operations with intelligent orchestration</li><li><strong>Tool Integration:</strong> Seamlessly integrate with existing tools and APIs</li><li><strong>Learning & Adaptation:</strong> Agents that improve over time based on outcomes and feedback</li></ul><p>Transform your content operations with AI-powered intelligent agents.</p>`,
    category: "Automation",
    color: "#A29BFE",
...
3. npm run dev
  ...
  },
  {
    ...
    intro: `<h3>Welcome to Digital Asset Management</h3><p>The <strong>Digital Asset Management (DAM)</strong> system is your centralized hub for managing all media assets across your organization. With AI-powered intelligence and cloud-scale infrastructure, DAM makes it easy to store, organize, find, and deliver assets efficiently.</p><h3>Key Features</h3><ul><li><strong>AI-Powered Tagging:</strong> Automatic metadata generation using computer vision and machine learning</li><li><strong>Smart Search:</strong> Find assets instantly with intelligent search across metadata, tags, and visual similarity</li><li><strong>Image Transformation:</strong> On-the-fly image optimization, resizing, and format conversion</li><li><strong>Global CDN:</strong> Fast asset delivery worldwide through CloudFront and ImageKit</li><li><strong>Version Control:</strong> Track asset history and maintain multiple versions</li></ul><p>Streamline your media workflow with intelligent asset management.</p>`,
